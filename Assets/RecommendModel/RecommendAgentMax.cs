...
public class RecommendAgentMax : Agent
{
    ...
    {
        sensor.AddObservation(flagVisited[0]);
        sensor.AddObservation(flagVisited[1]);
        sensor.AddObservation(flagVisited[2]);
        sensor.AddObservation(flagVisited[3]);
        sensor.AddObservation(flagVisited[4]);
        sensor.AddObservation(flagVisited[5]);
        sensor.AddObservation(flagVisited[6]);
        sensor.AddObservation(flagVisited[7]);
